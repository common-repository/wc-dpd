...
class Shipping
{
    ...
    public static function displayDpdParcelShopShippingMethodAdditionalContent($method, $index)
    {
        ...
        if ($method->id !== DpdParcelShopShippingMethod::SETTINGS_ID_KEY) {
            return $method;
        }
        ...
        // Check eligibility for Alzabox and Slovenska posta boxes
        ...
        echo include_template('parcelshop-shipping-method-content.php', [
    ...
    public static function maybeHideParcelshopsBasedOnWeightAndVolume($parcelshops)
    {
        ...
        if (!$is_package_eligible_for_alzabox || !$is_package_eligible_for_slovenska_posta_box) {
    ...
    public static function maybeClearChosenParcelshopDataFragments($fragments)
    {
        ...
        if ($is_package_eligible_for_a_general_parcelbox || $is_package_eligible_for_alzabox || $is_package_eligible_for_slovenska_posta_box) {
